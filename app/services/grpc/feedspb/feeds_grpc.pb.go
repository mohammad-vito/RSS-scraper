...
const (
	FeedService_GetFeed_FullMethodName     = "/feeds.FeedService/GetFeed"
	FeedService_GetFeedList_FullMethodName = "/feeds.FeedService/GetFeedList"
)
...
func (c *feedServiceClient) GetFeedList(ctx context.Context, in *GetFeedListRequest, opts ...grpc.CallOption) (*GetFeedListResponse, error) {
...
func (UnimplementedFeedServiceServer) GetFeedList(context.Context, *GetFeedListRequest) (*GetFeedListResponse, error) {
...
func _FeedService_GetFeedList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).GetFeedList(ctx, req.(*GetFeedListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/services/grpc/feedspb/feeds.proto",
}
